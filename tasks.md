...
- [ ] When searching, assume the string typed must be a the start of the table/view/database object name. Only if the user start with a *, search anywhere in the name.
