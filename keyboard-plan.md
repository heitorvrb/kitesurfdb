- [ ] When I hit arrow-key-down in the search field on the search model, and search results exist, and the cursor is already on the 'end' of the search input field, focus on search results
